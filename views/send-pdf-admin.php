    ...
    if (isset($_POST['idform']) && ((isset($_REQUEST['security-sendform']) && wp_verify_nonce($_POST['security-sendform'], 'go-sendform')) || (isset($_REQUEST['wpcf7_import_nonce']) && wp_verify_nonce($_POST['wpcf7_import_nonce'], 'go_import_nonce')))) {
      ...
      if (isset($meta_values['generate_pdf']) && !empty($meta_values['generate_pdf'])) {
        ...
        if (isset($meta_values["margin_header"]) && $meta_values["margin_header"] != '') {
          $marginHeader = esc_html($meta_values["margin_header"]);
        }
        if (isset($meta_values["margin_top"]) && $meta_values["margin_top"] != '') {
          $marginTop = esc_html($meta_values["margin_top"]);
        }
        if (isset($meta_values["margin_left"]) && $meta_values["margin_left"] != '') {
          $marginLeft = esc_html($meta_values["margin_left"]);
        }
        if (isset($meta_values["margin_right"]) && $meta_values["margin_right"] != '') {
          $marginRight = esc_html($meta_values["margin_right"]);
        }
        ...
        if (empty($meta_values["margin_auto_header"]) || (isset($meta_values["margin_auto_header"]) && $meta_values["margin_auto_header"] == '')) {
          $meta_values["margin_auto_header"] = 'stretch';
        }
        if (empty($meta_values["margin_auto_header"]) || (isset($meta_values["margin_auto_bottom"]) && $meta_values["margin_auto_bottom"] == '')) {
          $meta_values["margin_auto_bottom"] = 'stretch';
        }

        if (isset($meta_values["margin_auto_header"]) && $meta_values["margin_auto_header"] != '') {
          $setAutoBottomMargin = esc_html($meta_values["margin_auto_header"]);
        }
        if (isset($meta_values["margin_auto_bottom"]) && $meta_values["margin_auto_bottom"] != '') {
          $setAutoBottomMargin = esc_html($meta_values["margin_auto_bottom"]);
        }
        ...
        if (isset($meta_values["image"]) && !empty($meta_values["image"])) {
          ...
          if (empty($meta_values['image-width'])) {
            $imgWidth = esc_html($width);
          } else {
            $imgWidth = esc_html($meta_values['image-width']);
          }
          if (empty($meta_values['image-height'])) {
            $imgHeight = esc_html($height);
          } else {
            $imgHeight = esc_html($meta_values['image-height']);
          }
          ...
          if (isset($meta_values["margin_bottom_header"]) && $meta_values["margin_bottom_header"] != '') {
            $marginBottomHeader = esc_html($meta_values["margin_bottom_header"]);
          }
        ...
        if (isset($meta_values["separate"])) {
          if ($meta_values["separate"] == 'none') {
            $tagSeparate = '';
          }
          if ($meta_values["separate"] == 'comma') {
            $tagSeparate = ', ';
          }
          if ($meta_values["separate"] == 'space') {
            $tagSeparate = ' ';
          }
          if ($meta_values["separate"] == 'dash') {
            $tagSeparate = '- ';
          }
          if ($meta_values["separate"] == 'star') {
            $tagSeparate = '<i class="fas">&#xf621</i> ';
          }
          if ($meta_values["separate"] == 'rightarrow') {
            $tagSeparate = '<i class="fas">&#xf061</i> ';
          }
          if ($meta_values["separate"] == 'double-right-arrow') {
            $tagSeparate = '<i class="fas">&#xf101</i> ';
          }
          if ($meta_values["separate"] == 'cornerarrow') {
            $tagSeparate = '<i class="fas">&#xf064</i> ';
          }
        }
        $tagSeparateAfter = ' ';
        if (isset($meta_values["separate_after"])) {
          if ($meta_values["separate_after"] == 'none') {
            $tagSeparateAfter = '';
          }
          if ($meta_values["separate_after"] == 'comma') {
            $tagSeparateAfter = ', ';
          }
          if ($meta_values["separate_after"] == 'space') {
            $tagSeparateAfter = ' ';
          }
          if ($meta_values["separate_after"] == 'linebreak') {
            $tagSeparateAfter = '<br />';
          }
        }
    ...
    ?>
      ...
      <form method="post" action="" name="valide_settings">
        ...
        <div class="postbox">
          ...
          <span class="dashicons customDashicons dashicons-admin-settings"></span>
          <h3 class="hndle" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><?php _e('General Settings', WPCF7PDF_TEXT_DOMAIN); ?></h3>
          <div class="inside">
              ...
              <tbody id="the-list">
                  ...
                  <td style="text-align:left;">
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_left" name="wp_cf7pdf_settings[disable-pdf]" value="true" <?php if (isset($meta_values["disable-pdf"]) && $meta_values["disable-pdf"] == 'true') {
                                                                                                                                        echo ' checked';
                                                                                                                                      } ?> />
                        <label for="switch_left"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_right" name="wp_cf7pdf_settings[disable-pdf]" value="false" <?php if (empty($meta_values["disable-pdf"]) || (isset($meta_values["disable-pdf"]) && $meta_values["disable-pdf"] == 'false')) {
                                                                                                                                          echo ' checked';
                                                                                                                                        } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <select name="wp_cf7pdf_settings[send-attachment]" class="wpcf7-form-field">
                      <option value="sender" <?php if (isset($meta_values["send-attachment"]) && $meta_values["send-attachment"] == "sender") {
                                                echo ' selected';
                                              } ?>><?php _e('Sender', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="recipient" <?php if (isset($meta_values["send-attachment"]) && $meta_values["send-attachment"] == "recipient") {
                                                  echo ' selected';
                                                } ?>><?php _e('Recipient', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="both" <?php if ((isset($meta_values["send-attachment"]) && $meta_values["send-attachment"] == "both") || empty($meta_values["send-attachment"])) {
                                              echo ' selected';
                                            } ?>><?php _e('Both', WPCF7PDF_TEXT_DOMAIN); ?></option>
                    </select>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
                    <hr style="background-color: <?php echo esc_html($colors[2]); ?>; height: 1px; border: 0;">
                  </td>
                </tr>
                <tr style="vertical-align: middle;margin-top:15px;">
                  ...
                  <td style="text-align:left;">
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_insert" name="wp_cf7pdf_settings[disable-insert]" value="true" <?php if (isset($meta_values["disable-insert"]) && $meta_values["disable-insert"] == 'true') {
                                                                                                                                            echo ' checked';
                                                                                                                                          } ?> />
                        <label for="switch_insert"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_insert_no" name="wp_cf7pdf_settings[disable-insert]" value="false" <?php if (empty($meta_values["disable-insert"]) || (isset($meta_values["disable-insert"]) && $meta_values["disable-insert"] == 'false')) {
                                                                                                                                                  echo ' checked';
                                                                                                                                                } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_csv" name="wp_cf7pdf_settings[disable-csv]" value="true" <?php if (isset($meta_values["disable-csv"]) && $meta_values["disable-csv"] == 'true') {
                                                                                                                                      echo ' checked';
                                                                                                                                    } ?> />
                        <label for="switch_csv"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_csv_no" name="wp_cf7pdf_settings[disable-csv]" value="false" <?php if (empty($meta_values["disable-csv"]) || (isset($meta_values["disable-csv"]) && $meta_values["disable-csv"] == 'false')) {
                                                                                                                                            echo ' checked';
                                                                                                                                          } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <select name="wp_cf7pdf_settings[send-attachment2]" class="wpcf7-form-field">
                      <option value="sender" <?php if (isset($meta_values["send-attachment2"]) && isset($meta_values["send-pdf"]) && $meta_values["send-pdf"] == "sender") {
                                                echo ' selected';
                                              } ?>><?php _e('Sender', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="recipient" <?php if (isset($meta_values["send-attachment2"]) && $meta_values["send-attachment2"] == "recipient") {
                                                  echo ' selected';
                                                } ?>><?php _e('Recipient', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="both" <?php if ((isset($meta_values["send-attachment2"]) && $meta_values["send-attachment2"] == "both") || empty($meta_values["send-attachment2"])) {
                                              echo ' selected';
                                            } ?>><?php _e('Both', WPCF7PDF_TEXT_DOMAIN); ?></option>
                    </select>
                  </td>
                ...
                <tr>
                  <td><?php _e('Change CSV separator', WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <p><i><?php _e("By defaut it's separated by commas", WPCF7PDF_TEXT_DOMAIN); ?></i></p>
                  </td>
                  <td><input size="3" type="text" name="wp_cf7pdf_settings[csv-separate]" class="wpcf7-form-field" value="<?php if (isset($meta_values["csv-separate"]) && !empty($meta_values["csv-separate"])) {
                                                                                                                            echo esc_html($meta_values["csv-separate"]);
                                                                                                                          } else {
                                                                                                                            echo ',';
                                                                                                                          } ?>" /></td>
                </tr>
                ...
                <tr>
                  ...
                  <!-- Begind: Set dinamic PDF name -->
                  <td>
                    <?php _e('Enter a name for your PDF', WPCF7PDF_TEXT_DOMAIN); ?>
                    <p>
                      (<i><?php _e("By default, the file's name will be 'document-pdf'", WPCF7PDF_TEXT_DOMAIN); ?></i>)
                      <?php
                      $WPCF7_flieds = $contact_form = WPCF7_ContactForm::get_instance(esc_html($idForm));
                      $fileTags = '';
                  ...
                  <td>
                    <input type="text" class="wpcf7-form-field" name="wp_cf7pdf_settings[pdf-name]" value="<?php if (isset($meta_values["pdf-name"]) && !empty($meta_values["pdf-name"])) {
                                                                                                              echo esc_html($meta_values["pdf-name"]);
                                                                                                            } ?>">.pdf<br /><br /><br />
                    <input type="text" class="wpcf7-form-field" size="30" name="wp_cf7pdf_settings[pdf-add-name]" value="<?php if (isset($meta_values["pdf-add-name"]) && !empty($meta_values["pdf-add-name"])) {
                                                                                                                            echo esc_html($meta_values["pdf-add-name"]);
                                                                                                                          } ?>" />
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_uploads" name="wp_cf7pdf_settings[pdf-uploads]" value="true" <?php if (isset($meta_values["pdf-uploads"]) && $meta_values["pdf-uploads"] == 'true') {
                                                                                                                                          echo ' checked';
                                                                                                                                        } ?> />
                        <label for="switch_uploads"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_uploads_no" name="wp_cf7pdf_settings[pdf-uploads]" value="false" <?php if (empty($meta_values["pdf-uploads"]) || (isset($meta_values["pdf-uploads"]) && $meta_values["pdf-uploads"] == 'false')) {
                                                                                                                                                echo ' checked';
                                                                                                                                              } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_filedelete" name="wp_cf7pdf_settings[pdf-file-delete]" value="true" <?php if (isset($meta_values["pdf-uploads-delete"]) && $meta_values["pdf-file-delete"] == 'true') {
                                                                                                                                                  echo ' checked';
                                                                                                                                                } ?> />
                        <label for="switch_filedelete"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_filedelete_no" name="wp_cf7pdf_settings[pdf-file-delete]" value="false" <?php if (empty($meta_values["pdf-file-delete"]) || (isset($meta_values["pdf-file-delete"]) && $meta_values["pdf-file-delete"] == 'false')) {
                                                                                                                                                      echo ' checked';
                                                                                                                                                    } ?> />
                ...
                <tr>
                  <td><?php _e('Other files attachments?', WPCF7PDF_TEXT_DOMAIN); ?><p>(<i><?php _e("Enter one URL file by line", WPCF7PDF_TEXT_DOMAIN); ?></i>)</p><textarea class="wpcf7-form-field" cols="100%" rows="5" name="wp_cf7pdf_settings[pdf-files-attachments]"><?php if (isset($meta_values["pdf-files-attachments"])) {
                                                                                                                                                                                                                                                                                echo esc_textarea($meta_values["pdf-files-attachments"]);
                                                                                                                                                                                                                                                                              } ?></textarea>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select name="wp_cf7pdf_settings[send-attachment3]" class="wpcf7-form-field">
                      <option value="sender" <?php if (isset($meta_values["send-attachment3"]) && isset($meta_values["send-pdf"]) && $meta_values["send-pdf"] == "sender") {
                                                echo ' selected';
                                              } ?>><?php _e('Sender', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="recipient" <?php if (isset($meta_values["send-attachment3"]) && $meta_values["send-attachment3"] == "recipient") {
                                                  echo ' selected';
                                                } ?>><?php _e('Recipient', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="both" <?php if ((isset($meta_values["send-attachment2"]) && $meta_values["send-attachment3"] == "both") || empty($meta_values["send-attachment3"])) {
                                              echo ' selected';
                                            } ?>><?php _e('Both', WPCF7PDF_TEXT_DOMAIN); ?></option>
                    </select>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_attachments" name="wp_cf7pdf_settings[disable-attachments]" value="true" <?php if (isset($meta_values["disable-attachments"]) && $meta_values["disable-attachments"] == 'true') {
                                                                                                                                                      echo ' checked';
                                                                                                                                                    } ?> />
                        <label for="switch_attachments"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_attachments_no" name="wp_cf7pdf_settings[disable-attachments]" value="false" <?php if (empty($meta_values["disable-attachments"]) || (isset($meta_values["disable-attachments"]) && $meta_values["disable-attachments"] == 'false')) {
                                                                                                                                                            echo ' checked';
                                                                                                                                                          } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_redirect" name="wp_cf7pdf_settings[redirect-to-pdf]" value="true" <?php if (isset($meta_values["redirect-to-pdf"]) && $meta_values["redirect-to-pdf"] == 'true') {
                                                                                                                                                echo ' checked';
                                                                                                                                              } ?> />
                        <label for="switch_redirect"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_redirect_no" name="wp_cf7pdf_settings[redirect-to-pdf]" value="false" <?php if (empty($meta_values["redirect-to-pdf"]) || (isset($meta_values["redirect-to-pdf"]) && $meta_values["redirect-to-pdf"] == 'false')) {
                                                                                                                                                    echo ' checked';
                                                                                                                                                  } ?> />
                        <label for="switch_redirect_no"><?php _e('No', WPCF7PDF_TEXT_DOMAIN); ?></label>
                      </div>
                    </div><br />
                    <input type="radio" class="wpcf7-form-field" name="wp_cf7pdf_settings[redirect-window]" value="on" <?php if ((isset($meta_values["redirect-window"]) && $meta_values["redirect-window"] == 'on') or empty($meta_values["redirect-window"])) {
                                                                                                                          echo ' checked';
                                                                                                                        } ?> /><?php _e('Same Window', WPCF7PDF_TEXT_DOMAIN); ?> <input type="radio" class="wpcf7-form-field" name="wp_cf7pdf_settings[redirect-window]" value="off" <?php if (isset($meta_values["redirect-window"]) && $meta_values["redirect-window"] == 'off') {
                                                                                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                                                                                      } ?> /><?php _e('New Window', WPCF7PDF_TEXT_DOMAIN); ?> <input type="radio" class="wpcf7-form-field" name="wp_cf7pdf_settings[redirect-window]" value="popup" <?php if (isset($meta_values["redirect-window"]) && $meta_values["redirect-window"] == 'popup') {
                                                                                                                                                                                                                                                                                                                                                                                                                                                      echo 'checked';
                ...
                <tr>
                  <td colspan="2">
                    <hr style="background-color: <?php echo $colors[2]; ?>; height: 1px; border: 0;">
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_pdf_zip" name="wp_cf7pdf_settings[pdf-to-zip]" value="true" <?php if (isset($meta_values["pdf-to-zip"]) && $meta_values["pdf-to-zip"] == 'true') {
                                                                                                                                          echo ' checked';
                                                                                                                                        } ?> />
                        <label for="switch_pdf_zip"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_pdf_zip_no" name="wp_cf7pdf_settings[pdf-to-zip]" value="false" <?php if (empty($meta_values["pdf-to-zip"]) || (isset($meta_values["pdf-to-zip"]) && $meta_values["pdf-to-zip"] == 'false')) {
                                                                                                                                              echo ' checked';
                                                                                                                                            } ?> />
                ...
                <tr>
                  <td>
                    <?php _e('Select a date and time format', WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <p><i><?php _e('By default, the date format is defined in the admin settings', WPCF7PDF_TEXT_DOMAIN); ?> (<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank"><?php _e('Formatting Date and Time', WPCF7PDF_TEXT_DOMAIN); ?></a>)</i></p>
                  </td>
                  <td>
                    <?php
                ...
                <tr>
                  <td>
                    <?php _e('Input encoding', WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <p><i><?php _e('mPDF accepts UTF-8 encoded text by default for all functions', WPCF7PDF_TEXT_DOMAIN); ?></i></p>
                  </td>
                  <td>
                    <?php
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_linebreak" name="wp_cf7pdf_settings[linebreak]" value="true" <?php if (isset($meta_values["linebreak"]) && $meta_values["linebreak"] == 'true') {
                                                                                                                                          echo ' checked';
                                                                                                                                        } ?> />
                        <label for="switch_linebreak"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_linebreak_no" name="wp_cf7pdf_settings[linebreak]" value="false" <?php if (empty($meta_values["linebreak"]) || (isset($meta_values["linebreak"]) && $meta_values["linebreak"] == 'false')) {
                                                                                                                                                echo ' checked';
                                                                                                                                              } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_autocomplete" name="wp_cf7pdf_settings[disabled-autocomplete-form]" value="true" <?php if (isset($meta_values["disabled-autocomplete-form"]) && $meta_values["disabled-autocomplete-form"] == 'true') {
                                                                                                                                                              echo ' checked';
                                                                                                                                                            } ?> />
                        <label for="switch_autocomplete"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_autocomplete_no" name="wp_cf7pdf_settings[disabled-autocomplete-form]" value="false" <?php if (empty($meta_values["disabled-autocomplete-form"]) || (isset($meta_values["disabled-autocomplete-form"]) && $meta_values["disabled-autocomplete-form"] == 'false')) {
                                                                                                                                                                    echo ' checked';
                                                                                                                                                                  } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_data_input" name="wp_cf7pdf_settings[data_input]" value="true" <?php if (isset($meta_values["data_input"]) && $meta_values["data_input"] == 'true') {
                                                                                                                                            echo ' checked';
                                                                                                                                          } ?> />
                        <label for="switch_data_input"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_data_input_no" name="wp_cf7pdf_settings[data_input]" value="false" <?php if (empty($meta_values["data_input"]) || (isset($meta_values["data_input"]) && $meta_values["data_input"] == 'false')) {
                                                                                                                                                  echo ' checked';
                                                                                                                                                } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_fillable_data" name="wp_cf7pdf_settings[fillable_data]" value="true" <?php if (isset($meta_values["fillable_data"]) && $meta_values["fillable_data"] == 'true') {
                                                                                                                                                  echo ' checked';
                                                                                                                                                } ?> />
                        <label for="switch_fillable_data"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_fillable_data_no" name="wp_cf7pdf_settings[fillable_data]" value="false" <?php if (empty($meta_values["fillable_data"]) || (isset($meta_values["fillable_data"]) && $meta_values["fillable_data"] == 'false')) {
                                                                                                                                                        echo ' checked';
                                                                                                                                                      } ?> />
                ...
                <tr>
                  ...
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_protect" name="wp_cf7pdf_settings[protect]" value="true" <?php if (isset($meta_values["protect"]) && $meta_values["protect"] == 'true') {
                                                                                                                                      echo ' checked';
                                                                                                                                    } ?> />
                        <label for="switch_protect"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_protect_no" name="wp_cf7pdf_settings[protect]" value="false" <?php if (empty($meta_values["protect"]) || (isset($meta_values["protect"]) && $meta_values["protect"] == 'false')) {
                                                                                                                                            echo ' checked';
                                                                                                                                          } ?> />
                ...
                <tr>
                  <td><!-- Proteger le pdf? -->
                    ...
                    ?>
                    <p><i><?php _e('Example (not working in preview mode):', WPCF7PDF_TEXT_DOMAIN);
                          echo ' <strong>' . cf7_sendpdf::wpcf7pdf_generateRandomPassword($nbPassword) . '</strong>'; ?></i></p>
                  </td>
                  <td>
                    <div style="">
                      <div class="switch-field">
                        <input class="switch_left" type="radio" id="switch_protect_uniquepassword" name="wp_cf7pdf_settings[protect_uniquepassword]" value="true" <?php if (isset($meta_values["protect_uniquepassword"]) && $meta_values["protect_uniquepassword"] == 'true') {
                                                                                                                                                                    echo ' checked';
                                                                                                                                                                  } ?> />
                        <label for="switch_protect_uniquepassword"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        <input class="switch_right" type="radio" id="switch_protect_uniquepassword_no" name="wp_cf7pdf_settings[protect_uniquepassword]" value="false" <?php if (empty($meta_values["protect_uniquepassword"]) || (isset($meta_values["protect_uniquepassword"]) && $meta_values["protect_uniquepassword"] == 'false')) {
                                                                                                                                                                          echo ' checked';
                                                                                                                                                                        } ?> />
                ...
                <tr>
                  <td><?php _e('Maximum number of characters for password?', WPCF7PDF_TEXT_DOMAIN); ?><p><i><?php _e('By default : 12', WPCF7PDF_TEXT_DOMAIN); ?></i></p>
                  </td>
                  <td><input type="text" size="3" class="wpcf7-form-field" name="wp_cf7pdf_settings[protect_password_nb]" value="<?php if (isset($meta_values["protect_password_nb"]) && $meta_values["protect_password_nb"] != '' && is_numeric($meta_values["protect_password_nb"])) {
                                                                                                                                    echo esc_html($meta_values["protect_password_nb"]);
                                                                                                                                  } else {
                                                                                                                                    echo esc_html($nbPassword);
                                                                                                                                  } ?>" /></td>
                </tr>

                <tr>
                  <td><?php _e('Or enter your unique password for all PDF files.', WPCF7PDF_TEXT_DOMAIN); ?></td>
                  <td><input type="text" class="wpcf7-form-field" name="wp_cf7pdf_settings[protect_password]" value="<?php if (isset($meta_values["protect_password"]) && $meta_values["protect_password"] != '') {
                                                                                                                        echo esc_html(stripslashes($meta_values["protect_password"]));
                                                                                                                      } ?>" /></td>
                </tr>

                <tr>
                  <td><?php _e('Or choose a tag for password for each PDF files.', WPCF7PDF_TEXT_DOMAIN); ?><p><i><?php _e('Like: [tag]', WPCF7PDF_TEXT_DOMAIN); ?></i></p>
                  </td>
                  <td><input type="text" class="wpcf7-form-field" name="wp_cf7pdf_settings[protect_password_tag]" value="<?php if (isset($meta_values["protect_password_tag"]) && $meta_values["protect_password_tag"] != '') {
                                                                                                                            echo esc_html($meta_values["protect_password_tag"]);
                                                                                                                          } ?>" /></td>
                </tr>
                ...
                <tr>
                  <td><?php _e('Delete all config for this form?', WPCF7PDF_TEXT_DOMAIN); ?><p><i><?php _e('Click Yes and save the form.', WPCF7PDF_TEXT_DOMAIN); ?></i></p>
                  </td>
                  <td>
                    <div style="">
                      <div class="switch-field">
        ...
        <div class="postbox">
          <div class="handlediv" style="height:1px!important;" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><br></div>
          <span class="dashicons customDashicons dashicons-pdf"></span>
          <h3 class="hndle" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><?php _e('Layout of your PDF', WPCF7PDF_TEXT_DOMAIN); ?></h3>
          <div class="inside openinside">
              ...
              <tbody id="the-list">
                <tr>
                  <td style="width: 60%;">
                    ...
                    <input id="upload_image" size="80%" class="wpcf7-form-field" name="wp_cf7pdf_settings[image]" value="<?php if (isset($meta_values['image'])) {
                                                                                                                            echo esc_url($meta_values['image']);
                                                                                                                          } ?>" type="text" /> <a href="#" id="upload_image_button" class="button" OnClick="this.blur();"><span> <?php _e('Select or Upload your picture', WPCF7PDF_TEXT_DOMAIN); ?> </span></a> <br />
                    <div style="margin-top:0.8em;">
                      <select name="wp_cf7pdf_settings[image-alignment]" class="wpcf7-form-field">
                        <option value="left" <?php if (isset($meta_values['image-alignment']) && ($meta_values['image-alignment'] == 'left')) {
                                                echo 'selected';
                                              } ?>><?php _e('Left', WPCF7PDF_TEXT_DOMAIN); ?></option>
                        <option value="center" <?php if (isset($meta_values['image-alignment']) && ($meta_values['image-alignment'] == 'center')) {
                                                  echo 'selected';
                                                } ?>><?php _e('Center', WPCF7PDF_TEXT_DOMAIN); ?></option>
                        <option value="right" <?php if (isset($meta_values['image-alignment']) && ($meta_values['image-alignment'] == 'right')) {
                                                echo 'selected';
                                              } ?>><?php _e('Right', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      </select>
                      <?php _e('Size', WPCF7PDF_TEXT_DOMAIN); ?> <input type="text" class="wpcf7-form-field" size="3" name="wp_cf7pdf_settings[image-width]" value="<?php if (isset($meta_values['image-width'])) {
                                                                                                                                                                      echo $meta_values['image-width'];
                                                                                                                                                                    } else {
                                                                                                                                                                      echo '150';
                                                                                                                                                                    } ?>" />&nbsp;X&nbsp;<input type="text" class="wpcf7-form-field" name="wp_cf7pdf_settings[image-height]" size="3" value="<?php if (isset($meta_values['image-height'])) {
                                                                                                                                                                                                                                                                                                echo esc_html($meta_values['image-height']);
                                                                                                                                                                                                                                                                                              } ?>" />px<br /><br />

                      <div style=""><?php _e('Display header on each page?', WPCF7PDF_TEXT_DOMAIN); ?>
                        <div class="switch-field-mini">
                          <input class="switch_left" type="radio" id="switch_page_header" name="wp_cf7pdf_settings[page_header]" value="1" <?php if (isset($meta_values["page_header"]) && $meta_values["page_header"] == 1) {
                                                                                                                                              echo ' checked';
                                                                                                                                            } ?> />
                          <label for="switch_page_header"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                          <input class="switch_right" type="radio" id="switch_page_header_no" name="wp_cf7pdf_settings[page_header]" value="0" <?php if (empty($meta_values["page_header"]) || (isset($meta_values["page_header"]) && $meta_values["page_header"] == 0)) {
                                                                                                                                                  echo ' checked';
                                                                                                                                                } ?> />
                          <label for="switch_page_header_no"><?php _e('No', WPCF7PDF_TEXT_DOMAIN); ?></label>
                        </div><br />
                        <?php _e('Margin Bottom Header', WPCF7PDF_TEXT_DOMAIN); ?> <input type="text" size="4" class="wpcf7-form-field" name="wp_cf7pdf_settings[margin_bottom_header]" value="<?php if (isset($meta_values["margin_bottom_header"]) && $meta_values["margin_bottom_header"] != '') {
                                                                                                                                                                                                  echo esc_html($meta_values["margin_bottom_header"]);
                                                                                                                                                                                                } else {
                                                                                                                                                                                                  echo esc_html($marginBottomHeader);
                                                                                                                                                                                                } ?>" />
                      </div>
                    </div>
                    ...
                    <?php _e('Enter a URL or upload an image:', WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <input id="upload_background" size="80%" class="wpcf7-form-field" name="wp_cf7pdf_settings[image_background]" value="<?php if (isset($meta_values['image_background'])) {
                                                                                                                                            echo esc_url($meta_values['image_background']);
                                                                                                                                          } ?>" type="text" /> <a href="#" id="upload_image_background" class="button" OnClick="this.blur();"><span> <?php _e('Select or Upload your picture', WPCF7PDF_TEXT_DOMAIN); ?> </span></a><br /><small><?php _e('Example for demo:', WPCF7PDF_TEXT_DOMAIN); ?> <a href="<?php echo esc_url(plugins_url('../images/background.jpg', __FILE__)); ?>" target="_blank"><?php _e('here', WPCF7PDF_TEXT_DOMAIN); ?></a></small><br />
                    <div style="margin-top:0.8em;">
                      <div style=""><?php _e('Display background on each page?', WPCF7PDF_TEXT_DOMAIN); ?>
                        <div class="switch-field-mini">
                          <input class="switch_left" type="radio" id="switch_page_background" name="wp_cf7pdf_settings[page_background]" value="1" <?php if (isset($meta_values["page_background"]) && $meta_values["page_background"] == 1) {
                                                                                                                                                      echo ' checked';
                                                                                                                                                    } ?>>
                          <label for="switch_page_background"><?php _e('Yes', WPCF7PDF_TEXT_DOMAIN); ?></label>
                          <input class="switch_right" type="radio" id="switch_page_background_no" name="wp_cf7pdf_settings[page_background]" value="0" <?php if (empty($meta_values["page_background"]) || (isset($meta_values["page_background"]) && $meta_values["page_background"] == 0)) {
                                                                                                                                                          echo ' checked';
                                                                                                                                                        } ?>>
                  ...
                  <td style="text-align:center;">
                    <div style="border:1px solid #CCCCCC;height:500px;padding:5px;<?php if (isset($meta_values['image_background'])) {
                                                                                    echo 'background: no-repeat url(' . esc_url($meta_values['image_background']);
                                                                                  } ?>);background-size: cover;">
                      <div style="text-align:<?php if (isset($meta_values['image-alignment'])) {
                                                echo esc_html($meta_values['image-alignment']);
                                              } ?>;margin-top:<?php if (isset($meta_values["margin_header"]) && $meta_values["margin_header"] != '') {
                                                                echo esc_html($meta_values["margin_header"]);
                                                              } else {
                                                                echo esc_html($marginHeader);
                                                              } ?>px;"><?php if (isset($meta_values['image'])) {
                                                                          echo '<img src="' . esc_url($meta_values['image']) . '" width="150">';
                                                                        } ?>
                      </div>
                      <?php
                      ...
                      if (isset($meta_values["margin_top"]) && $meta_values["margin_top"] != '') {
                        ...
                        if ($meta_values["margin_top"] < 40) {
                          $previewMargin = ($previewMargin - 40);
                        }
                        if ($meta_values["margin_top"] == 0) {
                          $previewMargin = -60;
                        }
                      } else {
            ...
            <table class="wp-list-table widefat fixed" cellspacing="0">
              <tbody id="the-list">
                ...
                <tr>
                  <td colspan="2">
                    <textarea name="wp_cf7pdf_settings[custom_css]" id="wp_cf7pdf_pdf_css" cols=70 rows=24 class="widefat textarea" style="height:250px;"><?php if (isset($meta_values['custom_css'])) {
                                                                                                                                                            echo esc_textarea($meta_values['custom_css']);
                                                                                                                                                          } ?></textarea>
                  </td>
                </tr>
                <tr>
              ...
              <tbody id="the-list">
                ...
                <tr>
                  <td colspan="2">
                    ...
                    <textarea id="cf7pdf_html_footer" name="wp_cf7pdf_settings[footer_generate_pdf]" rows="15" cols="80%"><?php if (isset($meta_values['footer_generate_pdf'])) {
                                                                                                                            echo esc_textarea($meta_values['footer_generate_pdf']);
                                                                                                                          } ?></textarea>
                  </td>
                </tr>
              </tbody>
            ...
            <table class="wp-list-table widefat fixed" cellspacing="0">
              <tbody id="the-list">
                ...
                <tr>
                  ...
                  <td>
                    <select name="wp_cf7pdf_settings[pdf-type]" class="wpcf7-form-field">
                      <option value="Letter" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'Letter')) {
                                                echo 'selected';
                                              } ?>>Letter</option>
                      <option value="Legal" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'Legal')) {
                                              echo 'selected';
                                            } ?>>Legal</option>
                      <option value="Executive" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'Executive')) {
                                                  echo 'selected';
                                                } ?>>Executive</option>
                      <option value="Folio" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'Folio')) {
                                              echo 'selected';
                                            } ?>>Folio</option>
                      <option value="Demy" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'Demy')) {
                                              echo 'selected';
                                            } ?>>Demy</option>
                      <option value="Royal" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'Royal')) {
                                              echo 'selected';
                                            } ?>>Royal</option>
                      <option value="4A0" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == '4A0')) {
                                            echo 'selected';
                                          } ?>>4A0</option>
                      <option value="2A0" <?php if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == '2A0')) {
                                            echo 'selected';
                                          } ?>>2A0</option>
                      <?php
                      for ($typeA = 0; $typeA <= 10; $typeA++) {
                        echo '<option value="A' . esc_html($typeA) . '"';
                        if ((isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'A' . $typeA)) or (empty($meta_values['pdf-type']) && $typeA == 4)) {
                          echo 'selected';
                        }
                      ...
                      for ($typeB = 0; $typeB <= 10; $typeB++) {
                        ...
                        if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'B' . $typeB)) {
                          echo 'selected';
                        }
                      ...
                      for ($typeC = 0; $typeC <= 10; $typeC++) {
                        ...
                        if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'C' . $typeC)) {
                          echo 'selected';
                        }
                      ...
                      for ($typeRA = 0; $typeRA <= 4; $typeRA++) {
                        ...
                        if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'RA' . $typeRA)) {
                          echo 'selected';
                        }
                      ...
                      for ($typeSRA = 0; $typeSRA <= 4; $typeSRA++) {
                        ...
                        if (isset($meta_values['pdf-type']) && ($meta_values['pdf-type'] == 'SRA' . $typeSRA)) {
                          echo 'selected';
                        }
                    ...
                    <select name="wp_cf7pdf_settings[pdf-orientation]" class="wpcf7-form-field">
                      <option value="-P" <?php if ((isset($meta_values['pdf-orientation']) && ($meta_values['pdf-orientation'] == '-P')) or empty($meta_values['pdf-orientation'])) {
                                            echo 'selected';
                                          } ?>><?php _e('Portrait', WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="-L" <?php if (isset($meta_values['pdf-orientation']) && ($meta_values['pdf-orientation'] == '-L')) {
                                            echo 'selected';
                                          } ?>><?php _e('Landscape', WPCF7PDF_TEXT_DOMAIN); ?></option>
                    </select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select name="wp_cf7pdf_settings[pdf-font]" class="wpcf7-form-field">
                      ...
                      foreach ($listFont as $font => $nameFont) {
                        $selected = '';
                        if (isset($meta_values['pdf-font']) && $meta_values['pdf-font'] == $nameFont) {
                          $selected = 'selected';
                        }
                    ...
                    <input name="wp_cf7pdf_settings[pdf-fontsize]" class="wpcf7-form-field" size="2" value="<?php if (isset($meta_values['pdf-fontsize']) && is_numeric($meta_values['pdf-fontsize'])) {
                                                                                                              echo esc_html($meta_values['pdf-fontsize']);
                                                                                                            } else {
                                                                                                              echo esc_html($fontsizePdf);
                                                                                                            } ?>">
                  </td>
                </tr>
                <tr>
                  <td><?php _e('Add a CSS file', WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <p><a href="<?php echo esc_url(plugins_url('../css/mpdf-style-A4.css', __FILE__)); ?>" target="_blank"><small><i><?php _e('Download a example A4 page here', WPCF7PDF_TEXT_DOMAIN); ?></i></small></a></p>
                  </td>
                  <td>
                    <input size="60%" class="wpcf7-form-field" name="wp_cf7pdf_settings[stylesheet]" value="<?php if (isset($meta_values['stylesheet'])) {
                                                                                                              echo esc_url($meta_values['stylesheet']);
                                                                                                            } ?>" type="text" /><br />
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <?php _e('Global Margin PDF', WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <p></p>
                  </td>
                  <td>
                    <?php _e('Margin Header', WPCF7PDF_TEXT_DOMAIN); ?> <input type="text" size="4" class="wpcf7-form-field" name="wp_cf7pdf_settings[margin_header]" value="<?php if (isset($meta_values["margin_header"]) && $meta_values["margin_header"] != '') {
                                                                                                                                                                                echo esc_html($meta_values["margin_header"]);
                                                                                                                                                                              } else {
                                                                                                                                                                                echo esc_html($marginHeader);
                                                                                                                                                                              } ?>" /> <?php _e('Margin Top Header', WPCF7PDF_TEXT_DOMAIN); ?> <input type="text" class="wpcf7-form-field" size="4" name="wp_cf7pdf_settings[margin_top]" value="<?php if (isset($meta_values["margin_top"]) && $meta_values["margin_top"] != '') {
                                                                                                                                                                                                                                                                                                                                                    echo esc_html($meta_values["margin_top"]);
                                                                                                                                                                                                                                                                                                                                                  } else {
                                                                                                                                                                                                                                                                                                                                                    echo esc_html($marginTop);
                                                                                                                                                                                                                                                                                                                                                  } ?>" /><br /><br />
                    <?php _e('Margin Left', WPCF7PDF_TEXT_DOMAIN); ?> <input type="text" size="4" class="wpcf7-form-field" name="wp_cf7pdf_settings[margin_left]" value="<?php if (isset($meta_values["margin_left"]) && $meta_values["margin_left"] != '') {
                                                                                                                                                                            echo esc_html($meta_values["margin_left"]);
                                                                                                                                                                          } else {
                                                                                                                                                                            echo esc_html($marginLeft);
                                                                                                                                                                          } ?>" /> <?php _e('Margin Right', WPCF7PDF_TEXT_DOMAIN); ?> <input type="text" class="wpcf7-form-field" size="4" name="wp_cf7pdf_settings[margin_right]" value="<?php if (isset($meta_values["margin_right"]) && $meta_values["margin_right"] != '') {
                                                                                                                                                                                                                                                                                                                                            echo esc_html($meta_values["margin_right"]);
                                                                                                                                                                                                                                                                                                                                          } else {
                                                                                                                                                                                                                                                                                                                                            echo esc_html($marginRight);
                                                                                                                                                                                                                                                                                                                                          } ?>" /><br /><br />
                    <?php _e('Margin Header Auto', WPCF7PDF_TEXT_DOMAIN); ?> <select name="wp_cf7pdf_settings[margin_auto_header]" class="wpcf7-form-field">
                      <option value="pad" <?php if (isset($meta_values["margin_auto_header"]) && $meta_values["margin_auto_header"] == 'pad') {
                                            echo 'selected';
                                          } ?>>pad</option>
                      <option value="stretch" <?php if (empty($meta_values["margin_auto_header"]) || (isset($meta_values["margin_auto_header"]) && $meta_values["margin_auto_header"] == 'stretch')) {
                                                echo 'selected';
                                              } ?>>stretch</option>
                      <option value="false" <?php if (isset($meta_values["margin_auto_header"]) && $meta_values["margin_auto_header"] == 'false') {
                                              echo 'selected';
                                            } ?>>false</option>
                    ...
                    <select name="wp_cf7pdf_settings[margin_auto_bottom]" class="wpcf7-form-field">
                      <option value="pad" <?php if (isset($meta_values["margin_auto_bottom"]) && $meta_values["margin_auto_bottom"] == 'pad') {
                                            echo 'selected';
                                          } ?>>pad</option>
                      <option value="stretch" <?php if (empty($meta_values["margin_auto_bottom"]) || (isset($meta_values["margin_auto_bottom"]) && $meta_values["margin_auto_bottom"] == 'stretch')) {
                                                echo 'selected';
                                              } ?>>stretch</option>
                      <option value="false" <?php if (isset($meta_values["margin_auto_bottom"]) && $meta_values["margin_auto_bottom"] == 'false') {
                                              echo 'selected';
                                            } ?>>false</option>
                    </select>
                  </td>
                ...
                <tr>
                  <td>
                    <?php _e('Choice of separator for checkboxes or radio buttons', WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <p></p>
                  </td>
                  <td><?php _e("Before:", WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <select name="wp_cf7pdf_settings[separate]" class="wpcf7-form-field">
                      <option value="none" <?php if (empty($meta_values["separate"]) || (isset($meta_values["separate"]) && $meta_values["separate"] == 'none')) {
                                              echo 'selected';
                                            } ?>><?php _e("None", WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="dash" <?php if (isset($meta_values["separate"]) && $meta_values["separate"] == 'dash') {
                                              echo 'selected';
                                            } ?>><?php _e("Dash", WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="star" <?php if (isset($meta_values["separate"]) && $meta_values["separate"] == 'star') {
                                              echo 'selected';
                                            } ?>><?php _e("Star", WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="rightarrow" <?php if (isset($meta_values["separate"]) && $meta_values["separate"] == 'rightarrow') {
                                                    echo 'selected';
                                                  } ?>><?php _e("Right Arrow", WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="double-right-arrow" <?php if (isset($meta_values["separate"]) && $meta_values["separate"] == 'double-right-arrow') {
                                                            echo 'selected';
                                                          } ?>><?php _e("Double Right Arrow", WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="cornerarrow" <?php if (isset($meta_values["separate"]) && $meta_values["separate"] == 'cornerarrow') {
                                                    echo 'selected';
                                                  } ?>><?php _e("Corner Arrow", WPCF7PDF_TEXT_DOMAIN); ?></option>
                    </select><br />
                    <?php _e("After:", WPCF7PDF_TEXT_DOMAIN); ?><br />
                    <select name="wp_cf7pdf_settings[separate_after]" class="wpcf7-form-field">
                      <option value="comma" <?php if (isset($meta_values["separate_after"]) && $meta_values["separate_after"] == 'comma') {
                                              echo 'selected';
                                            } ?>><?php _e("Comma", WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="space" <?php if (empty($meta_values["separate_after"]) || (isset($meta_values["separate_after"]) && $meta_values["separate_after"] == 'space')) {
                                              echo 'selected';
                                            } ?>><?php _e("Space", WPCF7PDF_TEXT_DOMAIN); ?></option>
                      <option value="linebreak" <?php if (isset($meta_values["separate_after"]) && $meta_values["separate_after"] == 'linebreak') {
                                                  echo 'selected';
                                                } ?>><?php _e("Line break", WPCF7PDF_TEXT_DOMAIN); ?></option>
                    </select><br />
                    <!--<?php _e('Other:', WPCF7PDF_TEXT_DOMAIN); ?> <input type="text" size="4" class="wpcf7-form-field" name="wp_cf7pdf_settings[separate_other]" value="<?php if (isset($meta_values["separate_other"]) && $meta_values["separate_other"] != '') {
                                                                                                                                                                              echo esc_html($meta_values["separate_other"]);
                                                                                                                                                                            } else {
                                                                                                                                                                              echo '';
                                                                                                                                                                            } ?>" />-->
                  </td>
                  ...
                  <td colspan="2">
                    <legend>
                      ...
                      <table>
                        ...
                        <tr>
                          <td width="50%">
                            <span class="mailtag code used" onclick="jQuery(this).selectText()" style="cursor: pointer;">
                              <strong>[reference]</strong>
                            </span><br />
                            <i><?php _e("[reference] is a simple mail-tag who is used for create unique PDF. It's also recorded in the database. Every PDF is named like this : name-pdf-uniqid() and it's uploaded in the upload folder of WordPress.", WPCF7PDF_TEXT_DOMAIN); ?></i><br /><br />
                            <span class="mailtag code used" onclick="jQuery(this).selectText()" style="cursor: pointer;">
                              <strong>[ID]</strong>
                            </span><br />
                            <i><?php _e("[ID] is a simple tag that comes from the database ID if you have allowed registration in the options.", WPCF7PDF_TEXT_DOMAIN); ?></i><br /><br />
                            <span class="mailtag code used" onclick="jQuery(this).selectText()" style="cursor: pointer;">
                              <strong>[avatar]</strong>
                            </span>
                            <br />
                            <i><?php _e("[avatar] is a simple mail-tag for the user Avatar URL.", WPCF7PDF_TEXT_DOMAIN); ?></i>
                          </td>
                          <td width="50%">
                            <?php if (empty($fileTags) || (isset($fileTags) && $fileTags == '')) {
                              $fileTags = '[file-1][file-2]';
                            } ?>
                            <i><?php echo sprintf(__('The <strong>[file]</strong> tags are for images? Enter them here to display them in images on your PDF and like this: %s', WPCF7PDF_TEXT_DOMAIN), esc_html($fileTags)); ?></i><br />
                            <small><?php _e('It will then be necessary to put them in the image HTML tag for the PDF layout.', WPCF7PDF_TEXT_DOMAIN); ?><br />
                              <?php _e('Use url- prefix for display URL like this:', WPCF7PDF_TEXT_DOMAIN); ?> <?php echo str_replace('[', '[url-', esc_html($fileTags)); ?>
                            </small><br />
                            <input type="text" class="wpcf7-form-field" name="wp_cf7pdf_settings[file_tags]" size="80%" value="<?php if (isset($meta_values['file_tags'])) {
                                                                                                                                  echo esc_html($meta_values['file_tags']);
                                                                                                                                } ?>" /><br /><br />
                            <i><?php echo __('Enter here your Shortcodes (separated by commas)', WPCF7PDF_TEXT_DOMAIN); ?></i><br /><small><?php _e('It will then be necessary to put them in the PDF layout. Test with this shortcode: [wpcf7pdf_test]', WPCF7PDF_TEXT_DOMAIN); ?></small><br /><input type="text" class="wpcf7-form-field" name="wp_cf7pdf_settings[shotcodes_tags]" size="80%" value="<?php if (isset($meta_values['shotcodes_tags'])) {
                                                                                                                                                                                                                                                                                                                                                                                                            echo esc_html($meta_values['shotcodes_tags']);
                                                                                                                                                                                                                                                                                                                                                                                                          } ?>" />
                          </td>
      ...
      <?php if (isset($meta_values["disable-insert"]) && $meta_values["disable-insert"] == "false") { ?>
        ...
        <div class="postbox">
          ...
          <div class="handlediv" style="height:1px!important;" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><br></div>
          <span class="dashicons customDashicons dashicons-list-view"></span>
          <h3 class="hndle"><?php _e('Last records', WPCF7PDF_TEXT_DOMAIN); ?></h3>
          <div class="inside">
            <a name="listing"></a>
            <?php
            $limitList = 15;
            $settingsLimit = get_post_meta(esc_html($idForm), '_wp_cf7pdf_limit', true);
            if (isset($settingsLimit) && $settingsLimit > 0) {
              $limitList = $settingsLimit;
            }
            ...
            <?php } else {
              _e('Data not found!', WPCF7PDF_TEXT_DOMAIN);
            } ?>
          </div>
        </div>
      <?php } ?>
      ...
      <div class="postbox">
        <div class="handlediv" style="height:1px!important;" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><br></div>
        <span class="dashicons customDashicons dashicons-download"></span>
        <h3 class="hndle" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><?php _e('Export Settings', WPCF7PDF_TEXT_DOMAIN); ?></h3>
        <div class="inside">
          <form method="post">
            <p>
      ...
      <div class="postbox">
        <div class="handlediv" style="height:1px!important;" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><br></div>
        <span class="dashicons customDashicons dashicons-upload"></span>
        <h3 class="hndle" title="<?php _e('Click to toggle', WPCF7PDF_TEXT_DOMAIN); ?>"><?php _e('Import Settings', WPCF7PDF_TEXT_DOMAIN); ?></h3>
        <div class="inside">
